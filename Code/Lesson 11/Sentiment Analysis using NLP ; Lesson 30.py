...
df_train = df_train.sample(n = 50, random_state = 20)
df_val = df_val.sample(n = 50, random_state = 20)
...
y_test_pred=grid_search.predict(X_val)
rf_train = accuracy_score(y_train, y_train_pred)
rf_test = accuracy_score(y_val, y_test_pred)
