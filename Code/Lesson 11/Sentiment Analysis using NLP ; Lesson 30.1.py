...
df_train = df_train.sample(n = 500, random_state = 20)
df_val = df_val.sample(n =500, random_state = 20)
...
# You can also perform hyperparameter tuning using GridSearchCV to find the best parameters
param_grid = {
...
prediction = rf_classifier.predict(new_text_vectorized)
